        ...
        <div>
            ...
            {variant === 'bar' ?
                <div className="melody-p-0.5">
                    <input className={`melody-file-upload ${disabled ? "disabled" : ""} melody-block melody-w-full melody-text-sm melody-text-gray-900 melody-border melody-border-gray-300 melody-rounded-lg melody-cursor-pointer melody-bg-gray-50 dark:melody-text-gray-400 focus:melody-outline-none dark:melody-bg-gray-700 dark:melody-border-gray-600 dark:melody-placeholder-gray-400`}
                           type="file"
                           id="fileUpload"
                           disabled={disabled}
                ...
                <>
                    <div className="melody-flex melody-items-center melody-justify-center melody-w-full">
                        <label className="melody-cursor-pointer melody-flex melody-flex-col melody-rounded-lg melody-border-4 melody-border-dashed melody-w-full melody-h-60 melody-p-10 melody-group melody-text-center">
                            <div className="melody-h-full melody-w-full melody-text-center melody-flex melody-flex-col melody-items-center melody-justify-center">
